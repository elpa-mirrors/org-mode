...
(defconst org-latex-language-alist
  (let ((de-default-plist '(:fontenc "T1" :babel "ngerman" :babel-ini-alt "german" :polyglossia "german" :polyglossia-variant "german" :lang-name "German" :script "latin" :script-tag "latn"))
    ...
    `(("af" :fontenc "T1" :babel "afrikaans" :polyglossia "afrikaans" :lang-name "Afrikaans" :script "latin" :script-tag "latn")
      ...
      ("ast" :fontenc "T1" :babel-ini-only "asturian" :polyglossia "asturian" :lang-name "Asturian" :script "latin" :script-tag "latn")
      ("bg"  :fontenc "T2A" :babel "bulgarian" :polyglossia "bulgarian" :lang-name "Bulgarian" :script "cyrillic" :script-tag "cyrl")
      ...
      ("br"  :fontenc "T1" :babel "breton" :polyglossia "breton" :lang-name "Breton" :script "latin" :script-tag "latn")
      ("ca"  :fontenc "T1" :babel "catalan" :polyglossia "catalan" :lang-name "Catalan" :script "latin" :script-tag "latn")
      ("cop"  :babel-ini-only "coptic" :polyglossia "coptic" :lang-name "Coptic" :script "coptic" :script-tag "copt")
      ("cs"  :fontenc "T1" :babel "czech" :polyglossia "czech" :lang-name "Czech" :script "latin" :script-tag "latn")
      ("cy"  :fontenc "T1" :babel "welsh" :polyglossia "welsh" :lang-name "Welsh" :script "latin" :script-tag "latn")
      ("da"  :fontenc "T1" :babel "danish" :polyglossia "danish" :lang-name "Danish" :script "latin" :script-tag "latn")
      ("de" ,@de-default-plist)
      ("de-de" ,@de-default-plist)
      ("de-at" :fontenc "T1" :babel "naustrian" :babel-ini-alt "german-austria" :polyglossia "german" :polyglossia-variant "austrian" :lang-name "German" :script "latin" :script-tag "latn")
      ("dsb" :fontenc "T1" :babel "lowersorbian" :babel-ini-alt "lsorbian" :polyglossia "sorbian" :polyglossia-variant "lower" :lang-name "Lower Sorbian" :script "latin" :script-tag "latn")
      ("dv" :polyglossia "divehi" :lang-name "Dhivehi" :script "latin" :script-tag "latn")
      ("el" :fontenc "LGR" :babel "greek" :polyglossia "greek" :lang-name "Greek" :script "greek" :script-tag "grek")
      ("el-polyton"  :fontenc "LGR" :babel "polutonikogreek" :babel-ini-alt "polytonicgreek" :polyglossia "greek" :polyglossia-variant "polytonic" :lang-name "Polytonic Greek" :script "greek" :script-tag "grek")
      ("grc" :fontenc "LGR" :babel "greek.ancient" :babel-ini-alt "ancientgreek" :polyglossia "greek" :polyglossia-variant "ancient" :lang-name "Ancient Greek" :script "greek" :script-tag "grek")
      ("en"    :fontenc "T1" :babel "english" :polyglossia "english" :polyglossia-variant "usmax" :lang-name "English" :script "latin" :script-tag "latn")
      ("en-au" :fontenc "T1" :babel "australian" :polyglossia "english" :polyglossia-variant "australian" :lang-name "English" :script "latin" :script-tag "latn")
      ("en-ca" :fontenc "T1" :babel "canadian" :polyglossia "english" :polyglossia-variant "canadian" :lang-name "English" :script "latin" :script-tag "latn")
      ("en-gb" :fontenc "T1" :babel "british" :polyglossia "english" :polyglossia-variant "uk" :lang-name "English" :script "latin" :script-tag "latn")
      ("en-nz" :fontenc "T1" :babel "newzealand" :polyglossia "english" :polyglossia-variant "newzealand" :lang-name "English" :script "latin" :script-tag "latn")
      ("en-us" :fontenc "T1" :babel "american" :polyglossia "english" :polyglossia-variant "usmax" :lang-name "English" :script "latin" :script-tag "latn")
      ("eo" :fontenc "T1" :babel "esperanto" :polyglossia "esperanto" :lang-name "Esperanto" :script "latin" :script-tag "latn")
      ("es"    :fontenc "T1" :babel "spanish" :polyglossia "spanish" :lang-name "Spanish" :script "latin" :script-tag "latn")
      ("es-mx" :fontenc "T1" :babel "spanishmx" :polyglossia "spanish" :polyglossia-variant "mexican" :lang-name "Spanish" :script "latin" :script-tag "latn")
      ("et" :fontenc "T1" :babel "estonian" :polyglossia "estonian" :lang-name "Estonian" :script "latin" :script-tag "latn")
      ("eu" :fontenc "T1" :babel "basque" :polyglossia "basque" :lang-name "Basque" :script "latin" :script-tag "latn")
      ("fa" :babel "persian" :polyglossia "persian" :lang-name "Persian" :script "arabic" :script-tag "arab")
      ("fi" :fontenc "T1" :babel "finnish" :polyglossia "finnish" :lang-name "Finnish" :script "latin" :script-tag "latn")
      ("fr"    :fontenc "T1" :babel "french" :polyglossia "french" :lang-name "French" :script "latin" :script-tag "latn")
      ("fr-ca" :fontenc "T1" :babel "canadien" :babel-ini-alt "canadian" :polyglossia "french" :polyglossia-variant "canadian" :lang-name "French" :script "latin" :script-tag "latn")
      ("fur" :fontenc "T1" :babel "friulian" :polyglossia "friulian" :lang-name "Friulian" :script "latin" :script-tag "latn")
      ("ga" :fontenc "T1" :babel "irish" :polyglossia "gaelic" :polyglossia-variant "irish" :lang-name "Irish Gaelic" :script "latin" :script-tag "latn")
      ("gd" :fontenc "T1" :babel "scottish" :polyglossia "gaelic" :polyglossia-variant "scottish" :lang-name "Scottish Gaelic" :script "latin" :script-tag "latn")
      ("gl" :fontenc "T1" :babel "galician" :polyglossia "galician" :lang-name "Galician" :script "latin" :script-tag "latn")
      ...
      ("hr" :fontenc "T1" :babel "croatian" :polyglossia "croatian" :lang-name "Croatian" :script "latin" :script-tag "latn")
      ("hsb" :fontenc "T1" :babel "uppersorbian" :polyglossia "sorbian" :polyglossia-variant "upper" :lang-name "Upper Sorbian" :script "latin" :script-tag "latn")
      ("hu" :fontenc "T1" :babel "magyar" :polyglossia "magyar" :lang-name "Magyar" :script "latin" :script-tag "latn")
      ...
      ("la-ecclesiastic" :fontenc "T1" :babel "ecclesiasticlatin" :polyglossia "latin" :polyglossia-variant "ecclesiastic" :lang-name "Ecclesiastic Latin" :script "latin" :script-tag "latn")
      ("lo" :babel-ini-only "lao" :polyglossia "lao" :lang-name "Lao" :script "lao" :script-tag "lao")
      ("lt" :fontenc "T1" :babel "lithuanian" :polyglossia "lithuanian" :lang-name "Lithuanian" :script "latin" :script-tag "latn")
      ("lv" :fontenc "T1" :babel "latvian" :polyglossia "latvian" :lang-name "Latvian" :script "latin" :script-tag "latn")
      ...
      ("nb" :fontenc "T1" :babel "norsk" :polyglossia "norwegian" :polyglossia-variant "bokmal" :lang-name "Norwegian Bokmål" :script "latin" :script-tag "latn")
      ("nl" :fontenc "T1" :babel "dutch" :polyglossia "dutch" :lang-name "Dutch" :script "latin" :script-tag "latn")
      ("nn" :fontenc "T1" :babel "nynorsk" :polyglossia "norwegian" :polyglossia-variant "nynorsk" :lang-name "Norwegian Nynorsk" :script "latin" :script-tag "latn")
      ("no" :fontenc "T1" :babel "norsk" :polyglossia "norsk" :lang-name "Norwegian" :script "latin" :script-tag "latn")
      ...
      ("pt"    :fontenc "T1" :babel "portuguese" :polyglossia "portuguese" :lang-name "Portuges" :script "latin" :script-tag "latn")
      ...
      ("ru" :fontenc "T2A" :babel "russian" :polyglossia "russian" :lang-name "Russian" :script "cyrillic" :script-tag "cyrl")
      ("sa" :babel-ini-only "sanskrit" :polyglossia "sanskrit" :lang-name "Sanskrit" :script "devanagari" :script-tag "deva")
      ("sk" :fontenc "T1" :babel "slovak" :polyglossia "slovak" :lang-name "Slovak" :script "latin" :script-tag "latn")
      ("sl" :fontenc "T1" :babel "slovene" :polyglossia "slovene" :lang-name "Slovene" :script "latin" :script-tag "latn")
      ("sq" :fontenc "T1" :babel "albanian" :polyglossia "albanian" :lang-name "Albanian" :script "latin" :script-tag "latn")
      ("sr" :fontenc "T1" :babel "serbian" :polyglossia "serbian" :lang-name "Serbian" :script "latin" :script-tag "latn")
      ("sr-cyrl" :fontenc "T2A" :babel-ini-only "serbian-cyrl" :polyglossia "serbian" :lang-name "Serbian" :script "cyrillic" :script-tag "cyrl")
      ("sr-latn" :fontenc "T1" :babel-ini-only "serbian-latin" :polyglossia "serbian" :lang-name "Serbian" :script "latin" :script-tag "latn")
      ("sv"  :fontenc "T1" :babel "swedish" :polyglossia "swedish" :lang-name "Swedish" :script "latin" :script-tag "latn")
      ...
      ("tk" :fontenc "T2A" :babel "turkmen" :polyglossia "turkmen" :lang-name "Turkmen" :script "latin" :script-tag "latn")
      ("tr" :babel "turkish" :polyglossia "turkish" :lang-name "Turkish" :script "latin" :script-tag "latn")
      ("uk" :fontenc "T2A" :babel "ukrainian" :polyglossia "ukrainian" :lang-name "Ukrainian" :script "cyrillic" :script-tag "cyrl")
...
- `:fontenc' the script code for the fontenc package (pdflatex)")
...
will omit the default packages and the font specification if you are
exporting to lualatex, and will include the
...
(defun org-latex--babel-ldf-list (langs)
  "Return the list of long language names for LANGS.
...
COMPILER is the intended LaTeX compiler
FONTSPEC-CONFIG is the plist with the font specifications
DEFAULT-FEATURES is the default features for all fonts
...
This part can be reused in pure fontspec and in fontspec+polyglossia."
  ...
  (let ((cjk-packages nil) ;; will we need the packages to support CJK fonts?
        (directlua nil)    ;; Did we write the \\directlua{} block?
        (fallback-alist nil))  ;; an alist (font_name . fallback-name)
    ;; First see if there is any CJK fonts
    ;; and add xeCJK
    (cl-loop
       for font-spec in fontspec-config
    ...
    (when default-features
      (insert (org-latex--create-default-fontspec-features
               default-features)))
    ;; Now collect the fallbacks
    (cl-loop
     for (font-family . config-plist) in fontspec-config
     do
     (when-let* ((fallback (plist-get config-plist :fallback)))
      ...
      (when fallback-alist ;; if there are fonts with fallbacks
        ...
        (cl-loop
         ...
         do
         (when-let*
             ((font-config (alist-get font-family fontspec-config nil nil #'string=))
           ...
           (let ((fallback-fonts
             ...
             (when fallback-fonts
               ...
               (dolist (fallback-font fallback-fonts)
                 ...
                 ;; FIXME: when script in exported documentd charsets (FFS)
                 (insert (format "  \"%s\",\n" fallback-font)))
               (insert " })\n")))))
        (when directlua ;; if we have found any lua fallbacks, close the lua block
          (insert "}\n")))
      (cl-loop
       for (font-family . font-config) in fontspec-config
       do
...
(defun org-latex--get-babel-lang (lang &optional default-lang)
  "Return the language id used by (LaTeX) babel for Org language LANG.
When LANG is \"AUTO\", return DEFAULT-LANG if given,
else signal error."
...
INFO is the export communication channel."
  (let ((compiler (plist-get info :latex-compiler))
    ...
    (with-temp-buffer
      ...
      ;; (message "FONTSPEC: unicode-math-options: %s" unicode-math-options)
      (cl-loop
...
legacy routines for language and babel guessing."
  (let ((compiler (plist-get info :latex-compiler))
        (multi-lang (plist-get info :latex-multi-lang)))
    ;; (message "Generating font specification preamble for %s using %s" compiler multi-lang)
    ;; (message "  unicode-math-options: %s" org-latex-unicode-math-options)
    ...
    (if (not (member-ignore-case compiler org-latex-compilers)) pkg-alist
	 ...
	 (pcase package
	   ...
	   (`(,_ ,pkg ,_ ,compilers) (and (member-ignore-case compiler compilers)
                                          (org-latex--keep-pkg pkg multi-lang)))
	   (_ t)))
       pkg-alist))))
...
See URL `https://orgmode.org/list/691643eb-49d0-45c3-ab7f-a1edbd093bef@gmail.com'
and `https://texfaq.org/FAQ-ftnsect'")
  ...
  (unless (org-element-property :footnote-section-p headline)
	...
	(let ((opt-title
	       (funcall (plist-get info :latex-format-headline-function)
			...
			(org-export-data-with-backend
                         ;; Return alternative title when provided or
                         ;; title itself.
